...
async function testNativeKeyv() {
  console.log('=== 原始 Keyv/Postgres 测试 V2 ===');
  
  try {
    console.log('\n1. 初始化 Keyv 与 PostgresStore');
    console.log('Keyv 类型:', typeof Keyv);
    console.log('PostgresStore 类型:', typeof PostgresStore);
